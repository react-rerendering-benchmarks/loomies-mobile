...
export const BottomNavigation = memo(() => {
  ...
  /*Prevent going back to the profile tab when the back button is pressed*/ backBehavior='none' initialRouteName='Loomies' screenOptions={{
    tabBarStyle: {
    ...
    headerShown: false
      ...
      tabBarIcon: ({
        color
      }) => screen.name !== 'Loomies' ? <FeatherIcon name={screen.iconName} size={20} color={color} /> : <Image source={images['015']} style={{
        width: 76,
        height: 76,
        top: -16
      }} />
